document.addEventListener('DOMContentLoaded', function () {
    ...
    function validateForm() {
        ...
        if (apellido.value.trim() === '') {
            document.querySelector('#inputLastNameError').textContent = 'El apellido del aprendiz es obligatorio.';
            isValid = false;
        } else if (!nombreRegex.test(apellido.value)) {
            document.querySelector('#inputLastNameError').textContent = 'El apellido solo puede contener letras, tildes, espacios y comillas simples y dobles.';
            isValid = false;
        }

        if (telefono.value.trim() === '') {
            document.querySelector('#telefonoError').textContent = 'El número de teléfono es obligatorio.';
            isValid = false;
        ...
        if (direccion.value.trim() === '') {
            document.querySelector('#inputDireccionError').textContent = 'La dirección es obligatoria.';
            isValid = false;
        }
        ...
        if (acudiente.value.trim() === '') {
            document.querySelector('#NameAcudientError').textContent = 'El nombre del acudiente es obligatorio.';
            isValid = false;
        ...
        if (telAcudiente.value.trim() === '') {
            document.querySelector('#TelAcudienteError').textContent = 'El teléfono del acudiente es obligatorio.';
            isValid = false;
        ...
        if (correoAcud.value.trim() === '') {
            document.querySelector('#EmailAcudError').textContent = 'El correo del acudiente es obligatorio.';
            isValid = false;
        }
